...
import { IInput, SchemeToDescriptorConverterType } from './input-base.types'

export const InputBaseCreator = (function () {
    /**
    ...
    const newFieldFromBuilder = (
        ...
        return new InputBase(descriptor)
    }
    ...
    const newFieldFromDescriptors = (
        ...
        for (const descriptor of descriptors) {
            output.push(new InputBase(descriptor))
        }
        return output
    }
    return {
