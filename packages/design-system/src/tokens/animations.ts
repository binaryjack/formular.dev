...
export const animations = {
    ...
    presets: {
        ...
        'drawer-slide-in-left': 'drawerSlideInLeft 150ms ease-out',
        'drawer-slide-out-left': 'drawerSlideOutLeft 150ms ease-in',
        'drawer-slide-in-right': 'drawerSlideInRight 150ms ease-out',
        'drawer-slide-out-right': 'drawerSlideOutRight 150ms ease-in',
        'drawer-slide-in-top': 'drawerSlideInTop 150ms ease-out',
        'drawer-slide-out-top': 'drawerSlideOutTop 150ms ease-in',
        'drawer-slide-in-bottom': 'drawerSlideInBottom 150ms ease-out',
        'drawer-slide-out-bottom': 'drawerSlideOutBottom 150ms ease-in',
