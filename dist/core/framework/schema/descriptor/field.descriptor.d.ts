...
import { IFieldError } from '../../models/errors/i-field-error';
import { IFieldGuide } from '../../models/errors/i-field-guide';
...
export declare const SFieldDescriptor: unique symbol;
/**
