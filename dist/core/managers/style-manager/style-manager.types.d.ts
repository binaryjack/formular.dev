import { InputClassStatesNamesType, InputClassStatesValuesEnum } from '../../framework/common/common.input.state.types';
import { IExtendedInputBase } from '../../input-engine/core/input-base/input-base.types';
export declare const SStyleManager: unique symbol;
export declare const defaultFieldInputCSSClassName = "f-input";
/**
 ...
 */
export declare const defaultFieldStateFlags: IFieldStateFlags;
/**
