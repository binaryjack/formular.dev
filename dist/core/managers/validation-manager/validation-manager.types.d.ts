...
import { IFieldError } from '../../framework/models/errors/i-field-error';
import { IFieldGuide } from '../../framework/models/errors/i-field-guide';
...
export declare const SValidationManager: unique symbol;
/**
...
export declare const newValidationResults: (isValid: boolean, results?: IValidationResult[], formId?: string) => IValidationResults;
export declare const newValidationResult: (state: boolean, fieldName: string, code: string, triggerEventTypes: EventsType[], error?: string, guide?: string) => IValidationResult;
 ...
 */
export type IValidationGeneric = (IValidationBase & IRequired) | (IValidationBase & IMax) | (IValidationBase & IMin) | (IValidationBase & IMaxLength) | (IValidationBase & IMinLength) | (IValidationBase & IPattern);
/**
 ...
 * ```
 */
export declare const ValidationErrorsCodes: {
