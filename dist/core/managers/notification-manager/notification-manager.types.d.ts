...
export declare const SNotificationManager: unique symbol;
export declare const SAutoTrackerNotificationManager: unique symbol;
...
export interface INotification {
    ...
    handleBatch?: (notifications: Array<{
        type: EventsType;
        data?: IEvents;
    }>) => void;
