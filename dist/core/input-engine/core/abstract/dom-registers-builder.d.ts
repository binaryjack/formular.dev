...
export declare const customEvent: (eventType: EventsType, handler: EventTypeSignature | KeyEventTypeSignature) => ICustomHandler;
...
export declare const DomRegisterBuilder: IDomRegisterBuilder;
