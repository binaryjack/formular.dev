...
import { IExtendedInputBase, IInput } from '../../core/input-base/input-base.types';
import { IClickBaseInput } from '../click-base/click-base-input.types';
export declare const SOptionBaseInput: unique symbol;
...
export interface IOptionBaseInput extends IOptionBaseInputProperties, IExtendedInputBase {
    ...
    tryGetOptionBySequenceIdThenIdOrValue: (sequenceId: number, id: string, value: string) => IOptionItem | null;
