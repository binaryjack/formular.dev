...
import { IFormularManager } from '../../managers/formular-manager/formular-manager.types';
import { INotificationManager } from '../../managers/notification-manager/notification-manager-base.types';
import { IValidableForm, IValidationManager } from '../../managers/validation-manager/validation-manager.types';
 ...
 * ```
 */
export type IFormular<T extends object> = IFormularBase<T> & INotificationManager & IFormularFlags & IValidationManager & IValidableForm;
/**
