...
declare const useMouseEvents: (isMoving: boolean, isMouseDown: boolean, setIsMoving: React.Dispatch<React.SetStateAction<boolean>>, setIsDragging: React.Dispatch<React.SetStateAction<boolean>>, setIsMouseDown: React.Dispatch<React.SetStateAction<boolean>>, handlePositionResolver: (value: number, force?: boolean) => void) => {
