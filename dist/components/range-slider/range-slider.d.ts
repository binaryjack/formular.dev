 ...
 */
export declare const RangeSlider: ({ fieldName, min, max, step, behavior, rangeFillColor, handleFillColor, handleStyle, handleStylePercentAdjust, handlerStyleWidth, handlerStyleHeight, slideBarHeight, debug }: RangeSliderProps) => import("@emotion/react/jsx-runtime").JSX.Element;
export {};
