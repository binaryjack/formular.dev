...
exports.passwordMediumValidator = void 0;
...
const passwordMediumValidator = (name, required = true) => {
    const constraints = [];
    if (required) {
    ...
    constraints.push(new validation_constraint_builder_1.ValidationConstraintBuilder('pattern')
        .setConstraint(validation_regex_patterns_1.passwordMediumPattern)
        .setName(name)
        .setErrorMessage(validation_localize_keys_1.ValidationLocalizeKeys.passwordMediumError)
        .setGuideMessage(validation_localize_keys_1.ValidationLocalizeKeys.passwordMediumGuide));
...
exports.passwordMediumValidator = passwordMediumValidator;
