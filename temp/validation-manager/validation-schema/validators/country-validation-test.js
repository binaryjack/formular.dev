...
exports.printCountriesSummary = exports.generateTestReport = exports.testDynamicValidation = exports.testEuropeanApp = exports.testSwissBusinessApp = exports.testUtilityFunctions = exports.testValidatorsObject = exports.testPatternManagement = exports.testMultiCountryValidators = exports.testCountryValidators = exports.testSwitzerlandValidators = exports.testData = void 0;
...
const testSwitzerlandValidators = () => {
    const swissPhone = (0, index_1.phoneSwitzerlandValidator)('phone');
    const swissNPA = (0, index_1.npaValidator)('npa');
    const swissAHV = (0, index_1.ahvValidator)('ahv');
...
exports.testSwitzerlandValidators = testSwitzerlandValidators;
...
const testCountryValidators = () => {
    const germanPhone = (0, index_1.phoneCountryValidator)('phone', 'DE');
    const ukPostal = (0, index_1.postalCodeCountryValidator)('postal', 'UK');
    const usSSN = (0, index_1.ssnCountryValidator)('ssn', 'US');
...
exports.testCountryValidators = testCountryValidators;
...
const testMultiCountryValidators = () => {
    ...
    const dachCountries = ['CH', 'DE', 'AT'];
    const europeanPhone = (0, index_1.phoneMultiCountryValidator)('phone', europeanCountries);
    const dachPostal = (0, index_1.postalCodeMultiCountryValidator)('postal', dachCountries);
...
exports.testMultiCountryValidators = testMultiCountryValidators;
...
const testPatternManagement = () => {
    ...
    const swissPhonePattern = index_1.PatternManager.getPattern('phone', 'CH');
    const germanPostalPattern = index_1.PatternManager.getPattern('postal', 'DE');
    console.log('✅ Swiss phone pattern retrieved:', swissPhonePattern?.source?.substring(0, 30) + '...');
    console.log('✅ German postal pattern retrieved:', germanPostalPattern?.source);
    // Test available countries
    const phoneCountries = index_1.PatternManager.getAvailableCountries('phone');
    const postalCountries = index_1.PatternManager.getAvailableCountries('postal');
    const ssnCountries = index_1.PatternManager.getAvailableCountries('ssn');
    ...
    const swissName = index_1.PatternManager.getCountryName('CH');
    const swissPrefix = index_1.PatternManager.getPhonePrefix('CH');
...
exports.testPatternManagement = testPatternManagement;
...
const testValidatorsObject = () => {
    ...
    const phoneValidatorFromObject = index_1.Validators.phoneSwitzerland('phone');
    const npaValidatorFromObject = index_1.Validators.npa('npa');
    const ahvValidatorFromObject = index_1.Validators.ahv('ahv');
    ...
    const phoneMultiFromObject = index_1.Validators.phoneMultiCountry('phone', ['CH', 'DE']);
    const postalMultiFromObject = index_1.Validators.postalCodeMultiCountry('postal', ['CH', 'AT']);
...
exports.testValidatorsObject = testValidatorsObject;
...
const testUtilityFunctions = () => {
    ...
    const allSupportedCountries = (0, index_1.getCountriesWithSupport)(['phone', 'postal', 'ssn']);
    const phonePostalCountries = (0, index_1.getCountriesWithSupport)(['phone', 'postal']);
    ...
    const countryInfo = (0, index_1.getCountryValidationInfo)();
...
exports.testUtilityFunctions = testUtilityFunctions;
...
const testSwissBusinessApp = () => {
    const swissBusinessValidators = {
        mainPhone: index_1.Validators.phoneSwitzerland('mainPhone'),
        mobilePhone: index_1.Validators.phoneSwitzerland('mobilePhone'),
        headquartersNPA: index_1.Validators.npa('headquartersNPA'),
        branchNPA: index_1.Validators.npa('branchNPA'),
        ceoAHV: index_1.Validators.ahv('ceoAHV'),
        hrManagerAHV: index_1.Validators.ahv('hrManagerAHV')
    };
    console.log('✅ Swiss business app validators created');
    return swissBusinessValidators;
};
exports.testSwissBusinessApp = testSwissBusinessApp;
// Pattern 2: European multi-national app
const testEuropeanApp = () => {
    const europeanCountries = ['CH', 'DE', 'AT', 'FR', 'IT', 'ES'];
    const europeanValidators = {
        customerPhone: index_1.Validators.phoneMultiCountry('customerPhone', europeanCountries),
        shippingPostal: index_1.Validators.postalCodeMultiCountry('shippingPostal', europeanCountries),
        billingPostal: index_1.Validators.postalCodeMultiCountry('billingPostal', europeanCountries)
    };
    console.log('✅ European multi-national app validators created');
    return europeanValidators;
};
exports.testEuropeanApp = testEuropeanApp;
// Pattern 3: Dynamic country-based validation
const testDynamicValidation = () => {
    const createCountrySpecificValidation = (country) => {
        return {
            phone: index_1.Validators.phoneCountry('phone', country),
            postal: index_1.Validators.postalCodeCountry('postal', country),
            ssn: index_1.Validators.ssnCountry('ssn', country)
        };
    };
...
exports.testDynamicValidation = testDynamicValidation;
...
const printCountriesSummary = () => {
    ...
    countryInfo.forEach(info => {
        ...
        console.log(`${info.code.padEnd(7)} | ${phone.padEnd(5)} | ${postal.padEnd(6)} | ${ssn.padEnd(6)} | ${info.phonePrefix}`);
    });
...
exports.printCountriesSummary = printCountriesSummary;
